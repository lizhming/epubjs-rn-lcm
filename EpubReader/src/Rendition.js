...
class Rendition extends Component {
  ...
  constructor(props) {
    ...
    RNFetchBlob.fs.readFile('../node_modules/@babel/polyfill/dist/polyfill.min.js', 'utf8').then(data=>{
      console.log(data);
    })
  }
  ...
  componentDidMount() {
    ...
    console.log('uuuuuuu '+this.props.url);
    console.log(EMBEDDED_HTML);
  ...
  _onBridgeMessage(e) {
    ...
    var decoded;
    console.log('_onBridgeMessage ' + e);
      ...
      <View ref="framer" style={[styles.container, {
        ...
        <WebView
          ...
          style={[styles.manager, {
            backgroundColor: this.props.backgroundColor || "#FF0FF0"
          }]}
          bounces={false}
          javaScriptEnabled={true}
          scrollEnabled={true}
          pagingEnabled={this.props.flow === "paginated"}
          onMessage={()=>{console.log('test');}}
